...
class AuthProvider with ChangeNotifier {
  ...
  void signUp(String email, String password, String firstname, String lastname, BuildContext context) {
    authService.signUp(email, password, firstname, lastname, context);
  }
}
