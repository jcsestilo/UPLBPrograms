...
public class GameTimer extends AnimationTimer{
	...
	public void handle(long currentNanoTime) {
		 ...
		 * */
//		System.out.println(TimeUnit.NANOSECONDS.toSeconds(currentNanoTime));
...
//		}
		 ...
		 * */
//		if(this.biscuitXPos <= GameStage.WINDOW_WIDTH-50){
//			this.biscuitXPos += 2;
//		}
//		this.moveBiscuit(this.biscuitXPos, this.biscuitYPos);
		...
		long startSec = TimeUnit.NANOSECONDS.toSeconds(this.startSpawn);
		if((currentSec - startSec)%3 == 0){
			this.biscuitXPos = r.nextInt(GameStage.WINDOW_WIDTH-50);
			this.biscuitYPos = r.nextInt(GameStage.WINDOW_HEIGHT-50);
		}else{
			this.moveBiscuit(biscuitXPos, biscuitYPos);
		}
	...
	private void addComponents(){
        ...
        double width = this.biscuit.getWidth();
        double height = this.biscuit.getHeight();

        //add bound/rectangle to the biscuit
        this.biscuitBounds = new Rectangle2D(biscuitXPos, biscuitYPos, width, height);
