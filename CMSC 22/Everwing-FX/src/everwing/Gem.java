...
class Gem extends Item {
	private final static Image GEM_IMAGE = new Image("images/gem.png");

	Gem(double x, double y){
		super(x,y,Gem.GEM_IMAGE);
	}

	@Override
	public void checkCollision(Guardian guardian){
		if(this.collidesWith(guardian)){
			System.out.println(guardian.getName() + " has collected a gem!");
			this.vanish();
			guardian.gainScore(10);
		}
	}
