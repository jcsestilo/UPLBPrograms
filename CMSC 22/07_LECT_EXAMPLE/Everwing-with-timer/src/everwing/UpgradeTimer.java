...
public class UpgradeTimer extends Thread {
	private int timeLeft;
	private Guardian guardian;
	
	private final static int UPGRADED_TIME = 5;
	
	public UpgradeTimer(Guardian guardian) {
		this.guardian = guardian;
		this.timeLeft = UpgradeTimer.UPGRADED_TIME;
	}
	...
	private void countDown(){
		...
		System.out.println(guardian.getName() + " goes back to normal bullet.");
		this.guardian.setBulletType(Bullet.ORDINARY_BULLET);
	}
